...
function show_bird(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            bSTR += "<div id='series" + jsonT2[0].ID_Bird + "' style='display:none;'>" + jsonT2[0].Body_Content + "<br/><br/></div>";
            ...
            $('#series' + jsonT2[0].ID_Bird).on('click', function () {
                $('#series' + jsonT2[0].ID_Bird).toggle();
